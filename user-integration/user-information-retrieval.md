...
{% hint style="warning" %}
**\[Deprecated]** Coinfirm integration has been deprecated. If you wish to use Coinfirm, please integrate with it directly. This is now only used to return previously stored results.&#x20;
{% endhint %}
